...
The result that we recieve is great! It shows us that our autoencoder was able to take our inputs and learn how to reconstruct them. This shows that the bottleneck has worked and was able to get the most important parts of the images.
...
As the images below are roughly the same we know that before and after encoding and decoding the data is roughly the same. Through the bottleneck we have limited the amount of noise that we are outputting. That means that our autoencoder is working successfully.
